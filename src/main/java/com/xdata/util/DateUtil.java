...
public class DateUtil
{
    ...
    /**14位的时间字符串
     ...
     @return String
     */
    public static synchronized String get14DateFormat(java.util.Date date)
    {
    ...
    public static java.util.List getBeforeNMonth(int monthNum) {
        if (monthNum > 12)
            monthNum = 12;
    ...
    /**
     *
     * 以14位字符串(格式:yyyyMMddHHmmss)，返回当前时间
     * @param
     * @return
     */
    ...
    /**
     * 以19位字符串(格式:yyyy-MM-dd HH:mm:ss)，返回当前时间
     * @param
     * @return
     */
    ...
    /**
     * 获取当月的上六个月，不包括当月、格式(yyyy-MM)
     * @param
     * @return
     */
    public static List<String> getPrevious6Month()
    {
        ...
        for (int i = -6; i <= -1; i++)
        {
            ...
            monthes.add(sdf.format(gc.getTime()));
        }
